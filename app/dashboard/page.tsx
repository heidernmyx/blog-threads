    ...
    <>
        ...
        <div className="flex flex-col justify-center">
          <div className="post-container flex flex-col items-center p-4 border border-solid border-gray-300 rounded-xl bg-opacity-50">
            <div className="w-full flex justify-start px-[1vw] py-[1vw]">
              ...
              <Input className="w-full ml-[1vw] border-none" onClick={() => newPostModal.current?.click()} placeholder="What's on your mind?" />
            </div>
            <Post/>
          </div>
        </div>
      ...
      <AlertDialog>
        <AlertDialogTrigger ref={newPostModal} asChild>
          <Button className="h-[10vh] w-[7vw] m-[1vw] fixed bottom-3 right-3"><span className="text-3xl">+</span></Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <Input className="mb-[1vh]" onChange={(e) => setTitle(e.target.value)} id="title" type="text" />
              <Label htmlFor="username">Username</Label>
              <Input className="mb-[1vh]" onChange={(e) => setUsername(e.target.value)} id="username" type="text" />
              <Label>Description</Label>
              <textarea onChange={(e) => setDescription(e.target.value)} title="post" className="w-full mb-[0.5vh] h-40 px-[1vw] py-[1vh]"></textarea>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
